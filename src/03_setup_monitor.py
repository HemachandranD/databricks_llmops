...
if __name__ == "__main__":
    ...
    app_infernece_table_full_name = (
        f"{catalog_name}.{gold_schema_name}.{app_inference_table_name_prefix}_payload"
    )
    app_inference_processed_table_name = (
    ...
    logger.info(
        f"Preprocesing the data from {app_infernece_table_full_name} for monitoring."
    )
    app_inference_processed_df = prepare_data_to_monitor(app_infernece_table_full_name)
